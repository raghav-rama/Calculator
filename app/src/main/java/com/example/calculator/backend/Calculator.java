...
public class Calculator extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container,
        ...
        setButtonValues();
        mBinding.buttonResult.setOnClickListener(view1 -> {
            InputStringExpression.originalExpression = mBinding.getEditText();
            SetData data = new SetData(new ArrayList<>(), new ArrayList<>());
...
//                mBinding.setTextView4(data.toString());
        ...
        mBinding.b0.setOnClickListener(view12 -> {
...
//                display();
        ...
        mBinding.b1.setOnClickListener(view13 -> {
...
//                display();
        ...
        mBinding.b2.setOnClickListener(view14 -> {
...
//                display();
        ...
        mBinding.b3.setOnClickListener(view15 -> {
...
//                display();
        ...
        mBinding.b4.setOnClickListener(view16 -> {
...
//                display();
        ...
        mBinding.b5.setOnClickListener(view17 -> {
...
//                display();
        ...
        mBinding.b6.setOnClickListener(view18 -> {
...
//                display();
        ...
        mBinding.b7.setOnClickListener( view19 -> {
...
//                display();
        ...
        mBinding.b8.setOnClickListener(view110 -> {
...
//                display();
        ...
        mBinding.b9.setOnClickListener(view111 -> {
...
//                display();
        ...
        mBinding.buttonClear.setOnClickListener(view113 -> mBinding.setEditText(""));
        mBinding.buttonAdd.setOnClickListener(view112 -> {
...
//                display();
        ...
        mBinding.buttonSubtract.setOnClickListener(view114 -> {
            number_extractor.hasPoint = false;
//                if(flag_num==0);
...
//                display(); //for debugging
        ...
        mBinding.buttonDivide.setOnClickListener(view115 -> {
            number_extractor.hasPoint = false;
            if(flag_num==0);
            else if(number_extractor.hasPoint);
...
//                display();
        ...
        mBinding.buttonPoint.setOnClickListener(view116 -> {
        ...
        mBinding.button.setOnClickListener(view117 -> mBinding.setEditText(new StringBuffer(mBinding.getEditText()).deleteCharAt(mBinding.getEditText().length() - 1).toString()));
